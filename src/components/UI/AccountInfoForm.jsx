...
const AccountInfoForm = ({register}) => {
   ...
   return (
      <div className='flex flex-col items-center mt-20 drop-shadow-xl '>
            <div className="border px-9 rounded-3xl bg-white flex flex-col items-center pb-4 pt-5" >
               ...
               <form className='w-full flex flex-col' onSubmit={register}>
                  <div className=" border-y-2 rounded-full bg-white px-4 py-1 align-top text-gray-600 focus:ring-gray-600 focus:outline-gray-400 mt-4 h-fit drop-shadow-sm font-xl flex w-full">
                     <input className=" font-semibold px-3 my-2  focus:outline-none w-full" name = "username" placeholder="Имя пользователя" required/>
                  </div>
                  <div  className=" border-y-2 rounded-full bg-white px-4 py-1 align-top text-gray-600 focus:ring-gray-600 focus:outline-gray-400 mt-4 h-fit drop-shadow-sm font-xl flex w-full">
                     <input className=" font-semibold px-3 my-2  focus:outline-none w-full" name = "password" placeholder="Пароль" type={`${seePass ?'text' :'password'}`} required/>
