         ...
         <MyModal visible={modal} setVisible= {setModal}>
            ...
            <div className="m-4 flex flex-col">
               ...
               <div className="flex flex-col items-start mx-8">
                  <Link to='/' className={`${pageClasses}`}>Начальная страница</Link>
                  <Link to='/my-events' className={`${window.location.pathname==='/my-events' ?cuurentPageClasses :pageClasses }`}>Мои события</Link>
